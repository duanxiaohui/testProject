...
.arrow {
	...
	<div class="arrow"><img src="images/assistant/arrow.png" height="450" /></div>
			<div id="stepbystep">
				<div id="sidetitle">设置日程助手</div>
				<div class="stepcell">
					<div class="stepcellin">
						<div class="sc_num"><img src="images/assistant/num_1.png"></div>
					  	<div class="sc_txt">如果浏览器没显示“书签栏”，需打开Chrome浏览器的书签栏。</div>
						<div class="sc_pic"><img src="images/assistant/chrome1.jpg" width="300"></div>
						<div style="margin-left:70px; color:#888">使用快捷键Ctrl+Shift+B，可打开书签栏</div>
					</div>
				</div>
				<div class="stepcell">
					<div class="stepcellin">
				...
				<div class="stepcell">
					<div class="stepcellin">
					  ...
					  <div class="sc_txt">在任意网站看到喜欢的内容，选中文字，再点击书签栏中的“日程助手”即可。</div>
						<div class="sc_pic"><img src="images/assistant/chrome2.jpg"></div>
					</div>
				</div>
			</div>
<script>
