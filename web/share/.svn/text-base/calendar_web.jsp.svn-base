...
<%
	...
	String calendarColor = (String) request.getAttribute("calendarColor");
...
<div class="calendar_top">
	...
	<div class="calendar_name e_clear">
		<dl>
			<dt><img src="<%=bgu%>" class="calendar_icon"/></dt>
...
<div class="calendar_footer">
	<p><img src="/share/images/cal_logo.png"/>本日历由365日历自动生成，随时查看相关活动请<a href="http://www.365rili.com/v4/product.html#coco" target="_blank">下载365日历手机版</a>，并关注<span class="footer_calendar_title"></span>日历</p>
</div>
<!--
...
<script type="text/javascript" src="/share/js/calendarPanel.js?20150729"></script>
