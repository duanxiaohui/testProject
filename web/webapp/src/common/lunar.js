define(function(require, exports, module) {
	...
	self.lunar_Info_detail = function(date, callback){
		var cld = cacheMgr.getCld(date.getFullYear(), date.getMonth());
		...
		info.lunar = '农历' + (cld_day.isLeap ? '闰 ' : '')+getChinaNum(cld_day.lMonth)+"月"+ cDay(cld_day.lDay);
		info.y_Info = cld_day.cYear + '年'+lunar_year(date) +" "+ cld_day.cMonth + '月' + cld_day.cDay + '日';
		try
		{
