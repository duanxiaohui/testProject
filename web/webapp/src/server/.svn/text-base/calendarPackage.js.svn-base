...
define(function(require, exports, module) {
	...
	self.getQunInfo = function(d, render){
		var urlAndParams = ["/qqun/getQunInfo.do", "?appID=", d.appID, "&openID=", d.openID, "&openKey=", d.openKey, "&groupOpenID=", d.groupOpenID].join("");
		$base.get({
			url:urlAndParams,
			success:render
		});
	...
	self.refresh = function(d, render){
		var urlAndParams = ["/qqun/refresh.do", "?appID=", d.appID, "&openID=", d.openID, "&openKey=", d.openKey, "&groupOpenID=", d.groupOpenID].join("");
		$base.get({
			url:urlAndParams,
			success:render
		});
