 ...
 */
define("atans/artDialog/6.0.0/dialog-drag-debug", [ "jquery-debug", "./popup-debug", "./drag-debug", "./dialog-debug", "./dialog-config-debug", "./ui-dialog-debug.css" ], function(require) {
