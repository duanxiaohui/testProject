		...
		var table = "<table> \
						<thead class='tablehead'> \
							<tr> \
								...
								<td class='thead"+rows+"' style='color:#ff5503;'>六</td> \
								<td class='thead"+rows+"' style='color:#ff5503;'>日</td> \
							</tr> \
						</thead> \
						<tbody>";
		var tdclass = "";
			...
			for ( var j = 0; j < 7; j++)
			{
				...
				if ( calData[i][j].today == false )
				{
					aDay += "	<div class='"+numtype+" number"+calData[i][j].rows+"'>"+calData[i][j].date+"</div>\
								<div class='chinaday chinaday"+calData[i][j].rows+" festival' style='color: "+calData[i][j].china.color+"; color: "+chineseColor+"'>"+calData[i][j].china.l_day+"</div>";
				}
				else
				{
					aDay += "	<div class='"+numtype+" number"+calData[i][j].rows+"' style='color: white;'>"+calData[i][j].date+"</div>\
								<div class='chinaday chinaday"+calData[i][j].rows+" festival' style='color: white; color: "+chineseColor+"'>"+calData[i][j].china.l_day+"</div>";
				}
