...
{  
if(obj.innerHTML != "")  {this.dateInput.value = obj.value; var arrrr = obj.value.split('-');myDate.setFullYear(arrrr[0]);myDate.setMonth(arrrr[1]-1);myDate.setDate(arrrr[2]);setTimeZero(myDate);endDate.setDate(arrrr[2]);setTimeZero(endDate);$('#timeSelectStr').text(getSelectTimeStr(myDate));showSelectedDateContent();}
this.hide();
};
