		...
		$.each(ar, function(index, o){
			if (lDate.lYear + 1984 == self.$year.val() && index >= today.getMonth()) {
                ...
                $.each(new Array(o.days), function(dayIndex){
					...
					var d1 = dayIndex;
					var d2 = parseInt(Lunar.DB.dateCn.indexOf(lDate.lDate));
