function Swipe(tBox, args) {
    ...
    function pointFun(e) {
        ...
        tPoint.touch = false;
        tPoint.mutiTouch = false;
        if (typeof tPoint.pointCallback == "function") {
            tPoint.pointCallback.call(this,tPoint);
        }
    }
    ...
    if(tPoint.pointDom){
        _this.find(tPoint.pointDom).off('touchend');
        _this.find(tPoint.pointDom).on('touchend', pointFun);
    }
