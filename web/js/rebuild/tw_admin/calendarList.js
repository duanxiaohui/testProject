/**
 * calendarList
 * @authors huangyi (you@example.org)
 * @date    2014-08-13 19:09:33
 * @version $Id$
 */
...
define([
	...
	var _ex = {
		...
		loadCalendarListData: function() {
			$.ajax({
				url: '/tuanwei/tw_getCalendarListByUser.do',
				type: 'post',
				dataType: 'json',
				success: function(data) {
					if (data.state == 'wrongpass') {
		...
		renderList: function() {
			...
			var tmpl = '\
				...
				htmlHeader = '<li class="e_clear" cldID="-1"><a href="javascript:;" class="my_calendar_nav_set calendar_ary_btn"></a><span id="sp_multi_calendar" class="my_calendar_nav_txt">所有消息(' + selectedInAryCount + ')</span></li>';
