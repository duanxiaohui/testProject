define([
	...
	function getForm() {
		if ($form) {
			...
			var tmpl = '<div id="div_add_schedule" class="add_schedule_layer complete ui-shadow none"><!--complete simple--><a href="javascript:;" class="close_btn js_close"></a><h2></h2><div class="add_schedule_content"><form><input type="hidden" name="scheduleId" value=""/><dl class="e_clear"><dt>内容：</dt><dd><textarea name="schTitle"></textarea></dd></dl>'+
