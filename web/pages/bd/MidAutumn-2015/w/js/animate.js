	...
	var ani = {
		                ...
		                params: [
		                    {
			        			...
			        			value: JSON.stringify({
			        				...
			        				link: 'http://www.365rili.com/pages/bd/MidAutumn-2015/w/index.html',
		...
		init: function () {
			...
			if(!to){
				...
				$('.openLettle').on('tap', function () {
					window.location.href = 'http://www.365rili.com/pages/bd/MidAutumn-2015/w/case.html?' + ['to=' + to, 'from1=' + from, 'job=' + job, 'customer=' + customer, 'beginDate=' + beginDate, 'endDate=' + endDate].join('&');
				});
			}
		},
		setSize: function () {
		...
		setup4: function () {
			...
			$('.setup4Btn').on('tap', function () {
				if(app.getUa.weixin){
					window.location.href = "/wx/login.do?redURL=" + encodeURIComponent('/pages/bd/MidAutumn-2015/w/form.html');
				}
				else{
					window.location.href = '/pages/bd/MidAutumn-2015/w/form.html';
				}
			});
		},
