...
(function () {
	...
	var q = {
		initPreview: function () {
		                ...
		                params: [
		                    {
			        			...
			        			value: JSON.stringify({
			        				...
			        				link: 'http://www.365rili.com/pages/bd/MidAutumn-2015/app/index.html?' + ['to=' + to, 'from1=' + from, 'job=' + job, 'customer=' + customer, 'beginDate=' + beginDate, 'endDate=' + endDate].join('&'),
			...
			function postShare () {
				$.ajax({
					url: '/pages/bd/MidAutumn-2015/shareInWX.html?ch=app'
				})
			}
		},
		initCase: function () {
			...
			$('.build').on('tap', function () {
				window.location.href = '/pages/bd/MidAutumn-2015/app/index.html?isLoaded=1';
			});
		...
		showShare: function () {
			if(app.getUa.weixin){
				...
				$.ajax({
					url: '/pages/bd/MidAutumn-2015/shareInApp.html'
				});
				app.call({
                    action: 'share',
                    params: [
