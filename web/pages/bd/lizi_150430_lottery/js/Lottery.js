...
Lottery.prototype = {
    ...
    drawPoint: function (x, y) {
        ...
        //手指擦掉canvas区域的大小
        this.maskCtx.arc(x, y, 80, 80, Math.PI * 2, true);
        this.maskCtx.fill();
    ...
    drawLottery: function () {
        this.background = this.background || this.createElement('canvas', {
            style: 'position:absolute;left:0;top:0; z-index:9;'
        });
        this.background.className = 'lotter_div'
        this.mask = this.mask || this.createElement('canvas', {
            style: 'position:absolute;left:0;top:0; z-index:10;'
        });
        this.mask.className = 'mask_layer';
