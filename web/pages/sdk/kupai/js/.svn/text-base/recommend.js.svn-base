					...
					url: function (o, p, c) {
						switch (p.action) {
				            case 1 :
				                ...
				                break;
				            case 2 :
				                url = 'http://hz.365rili.com/pages/sdk/kupai/schedule_list.html?calendarID=' + p.url;
				                break;
				            case 3 :
				                var uuid, cid;
				                var ids = p.url.split(',');
				                cid = ids[0];
				                uuid = ids[1];
				                url = 'http://hz.365rili.com/pages/sdk/kupai/schedule_details.html?uuid='+uuid+'&cid='+cid;
				                break;
				        }
				        return url
					}
