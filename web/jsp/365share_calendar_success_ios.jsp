...
<div id="info_container" class="info_container">
	...
	<div class = "submit_button_blue" align="center" onclick = "eventHandlers.open_click('ios', '<%=invitee%>');">
		点击进入我的日历
	</div>
	<div class="notice">
		如果您未安装：
	</div>
	<div class = "submit_button_green" align="center" onclick = "eventHandlers.dl_click('ios');">
		<img class = "icon_apple" src="/images/mobile/icon-apple.png"/>现在就下载吧
	</div>
